...
export default defineConfig({
    ...
    plugins: [
        ...
        VitePWA({
            ...
            includeAssets: ['/img/MPOS-logo.png', '/img/icons/ios/180.png'],
            manifest: {
                name: 'MPOS Refer & Win',
                short_name: 'MPOS Refer & Win',
                description: 'MPOS Refer & Win - Spin the wheel and win prizes!',
                theme_color: '#212f56',
                icons: [
                    {
                        src: 'img/MPOS-logo.png',
                        sizes: '743x743',
                        type: 'image/png',
                        purpose: 'maskable'
                    },
